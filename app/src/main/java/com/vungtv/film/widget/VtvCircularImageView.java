...
public class VtvCircularImageView extends ImageView {
    ...
    public VtvCircularImageView(final Context context) {
        this(context, null);
    }

    public VtvCircularImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VtvCircularImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.VtvCircularImageView, defStyleAttr, 0);

        // Init Border
        if (attributes.getBoolean(R.styleable.VtvCircularImageView_civ_border, true)) {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            setBorderWidth(attributes.getDimension(R.styleable.VtvCircularImageView_civ_border_width, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.VtvCircularImageView_civ_border_color, Color.WHITE));
        }

        // Init Shadow
        if (attributes.getBoolean(R.styleable.VtvCircularImageView_civ_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS;
            drawShadow(attributes.getFloat(R.styleable.VtvCircularImageView_civ_shadow_radius, shadowRadius), attributes.getColor(R.styleable.VtvCircularImageView_civ_shadow_color, shadowColor));
        }
    }
    ...
    private Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            LogUtils.e(getClass().toString(), "Encountered OutOfMemoryError while generating bitmap!");
            return null;
        }
    }
    //endregion
